...
//	cout <<"At: "<<sc_time_stamp()<<"	dp:	shift_A	"<<shift_A<<'\n';
	...
	cout <<"At: "<<sc_time_stamp()<<"	dp:	W		"<< W <<'\n';
	cout <<"At: "<<sc_time_stamp()<<"	dp:	sum		"<<sum<<'\n';
	cout <<"At: "<<sc_time_stamp()<<"	dp:	A_IN	"<<A_IN<<'\n';
	cout <<"At: "<<sc_time_stamp()<<"	dp:	B_IN	"<<B_IN<<'\n';
